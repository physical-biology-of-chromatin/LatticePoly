...
class EndtoEnd():
    ...
    def __init__(self, outputDir, initFrame):
        ...
        self.endtoendFile = os.path.join(self.reader.outputDir,"r_pos.res")
    ...
    def Compute(self):
        ...
        self.endtoend = np.zeros((self.reader.N, 3, self.reader.nTad), dtype=np.float32)
