...
std::string chromesizesPath;
std::string centromerePath;
...
void InputParser::ParseVars()
{
	...
	chromesizesPath		=GetValueOfKey<std::string>("chromesizesPath");
	centromerePath		=GetValueOfKey<std::string>("centromerePath");
