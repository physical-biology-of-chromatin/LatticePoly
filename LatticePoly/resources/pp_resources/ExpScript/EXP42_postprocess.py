...
exp = "EXP42_liqFraction_null_model"
...
#                 except :
#                         file = open(f"/Xnfs/physbiochrom/ppuel/data/{exp}/error_list.txt",'w')
#                         file.write(f"{ldens}, {n} error\n")
#                         file.close()

local_density_mean = np.load(f"/home/ppuel/data/{exp}/classifier/null_model_local_density_mean.npy")
sizes_max = np.load(f"/home/ppuel/data/{exp}/classifier/null_model_sizes_max.npy")
tau = np.load(f"/home/ppuel/data/{exp}/classifier/null_model_tau.npy")
