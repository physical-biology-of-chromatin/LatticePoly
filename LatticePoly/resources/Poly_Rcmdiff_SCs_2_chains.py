...
class PolyGyration():
	...
	def __init__(self, outputDir, initFrame):
		...
		self.reader2 = vtkReader(outputDir,2, initFrame, readLiq=False, readPoly=True)

					
		self.diffRcmFile = os.path.join(self.reader.outputDir, "diff_rcm.res")
