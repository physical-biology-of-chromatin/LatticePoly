...
python /home/ddasaro//LatticePoly/LatticePoly/resources/ReplicationAnalysis.py ${TMPDIR} 200000
...
tar --transform "s|^|${OUTDIR}/|" -czf /Xnfs/lbmcdb/Jost_team/ddasaro/year2/July23/bubble_long/0.001/${OUTDIR}.tar.gz -C ${TMPDIR} .
