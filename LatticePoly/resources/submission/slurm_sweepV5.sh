...
TMPDIR=${PARAM}_${VAL}
[ ! -z "${PARAM2}" ] && TMPDIR=${PARAM2}_${VAL2}_${TMPDIR}_EV_${EV}
...
SCRDIR=${PARAM}/${VAL}
[ ! -z "${PARAM2}" ] && SCRDIR=${PARAM2}/${VAL2}/${SCRDIR}/EV/${EV}
...
DATDIR=${PARAM}/${VAL}
[ ! -z "${PARAM2}" ] && DATDIR=${PARAM2}/${VAL2}/${DATDIR}/EV/${EV}
...
sed -e "${DIRSUB}""${VALSUB}""${VAL2SUB}""${EVSUB}" < data/input.cfg > ${TMPDIR}/input.cfg
