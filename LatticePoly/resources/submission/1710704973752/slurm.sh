...
python /home/ddasaro/LatticePoly/LatticePoly/resources/Forksnumber_chrom.py  ${TMPDIR}  50 0 
python /home/ddasaro/LatticePoly/LatticePoly/resources/Forksnumber_chrom.py  ${TMPDIR}  50 1 
python /home/ddasaro/LatticePoly/LatticePoly/resources/Forksnumber_chrom.py  ${TMPDIR}  50 2 
python /home/ddasaro/LatticePoly/LatticePoly/resources/Forksnumber_chrom.py  ${TMPDIR}  50 3 
python /home/ddasaro/LatticePoly/LatticePoly/resources/Forksnumber_chrom.py  ${TMPDIR}  50 4 
python /home/ddasaro/LatticePoly/LatticePoly/resources/Forksnumber_chrom.py  ${TMPDIR}  50 5 
python /home/ddasaro/LatticePoly/LatticePoly/resources/Forksnumber_chrom.py  ${TMPDIR}  50 6 
python /home/ddasaro/LatticePoly/LatticePoly/resources/Forksnumber_chrom.py  ${TMPDIR}  50 7 
python /home/ddasaro/LatticePoly/LatticePoly/resources/Forksnumber_chrom.py  ${TMPDIR}  50 8 
python /home/ddasaro/LatticePoly/LatticePoly/resources/Forksnumber_chrom.py  ${TMPDIR}  50 9 
python /home/ddasaro/LatticePoly/LatticePoly/resources/Forksnumber_chrom.py  ${TMPDIR}  50 10
python /home/ddasaro/LatticePoly/LatticePoly/resources/Forksnumber_chrom.py  ${TMPDIR}  50 11 
python /home/ddasaro/LatticePoly/LatticePoly/resources/Forksnumber_chrom.py  ${TMPDIR}  50 12 
python /home/ddasaro/LatticePoly/LatticePoly/resources/Forksnumber_chrom.py  ${TMPDIR}  50 13 
python /home/ddasaro/LatticePoly/LatticePoly/resources/Forksnumber_chrom.py  ${TMPDIR}  50 14 
python /home/ddasaro/LatticePoly/LatticePoly/resources/Forksnumber_chrom.py  ${TMPDIR}  50 15 
...
tar --transform "s|^|${OUTDIR}/|" -czf /Xnfs/physbiochrom/ddasaro/year3/March24/full_genome_S/${OUTDIR}.tar.gz -C ${TMPDIR} .
