...
class MonomerDmap():
	def __init__(self, outputDir, initFrame):
		...
		self.contactFile = os.path.join(self.reader.outputDir,"r_"+str(r)+"_"+str(initFrame)+ "_cis_hic.cool")
		self.timeFile = os.path.join(self.reader.outputDir,"cycles_r_"+str(r)+"_"+str(initFrame)+ "_cis_hic.res")
