...
class ForkCluster():
	...
	def __init__(self, outputDir, initFrame, threshold=0.5, nMax=10, cutoff=1/2**0.5 + 1e-3):
		...
		self.numFile = os.path.join(self.reader.outputDir, "forkDropNum.res")
		self.radFile = os.path.join(self.reader.outputDir, "forkRad.res")
		self.meanFile = os.path.join(self.reader.outputDir, "forkRadii.res")
