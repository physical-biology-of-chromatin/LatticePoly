...
class cluster_full_genome():
	def __init__(self, outputDir, initFrame):
		...
		self.Forks_per_clusterFile = os.path.join(outputDir,str(r)+"_"+str(initFrame)+"_"+str(interval)+"_forks_"+str(forks_n)+"percentage(1and2forks)_"+str(percentage)+"_cluster_full_genome.res")
