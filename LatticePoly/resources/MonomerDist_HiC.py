...
class MonomerDmap():
    ...
    def __init__(self, outputDir, initFrame):
        ...
        self.monomerFile = os.path.join(self.reader.outputDir, str(round(initFrame))+"monomerdistmat_z.res")
        self.contactFile = os.path.join(self.reader.outputDir, str(round(initFrame))+"contactProb_z.res")
    ...
    def Compute(self, domainstart, domainend):
        ...
        self.monomer     = self.monomer/(33)
        self.contactProb = (self.contactProb+np.transpose(self.contactProb))/(33)
